...
from agent.deepmdp_bisim_agent import BisimAgent
...
def parse_args():
    ...
    parser.add_argument('--decoder_type', default='pixel', type=str, choices=['pixel', 'identity', 'contrastive', 'reward', 'inverse'])
